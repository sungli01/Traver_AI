...
function Calendar({
  ...
  // Build holiday date set for modifiers
  ...
  return (
    <>
      <style>{`
        .holiday-day:not([aria-selected="true"]) {
          position: relative;
          color: #dc2626 !important;
          font-weight: 700;
        }
        .holiday-day:not([aria-selected="true"])::after {
          content: '';
          position: absolute;
          bottom: 2px;
          left: 50%;
        ...
        .sunday-day:not([aria-selected="true"]):not(.holiday-day) {
